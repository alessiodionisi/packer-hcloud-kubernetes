...
# kubelet
curl -OL https://raw.githubusercontent.com/kubernetes/release/v$KUBERNETES_RELEASE_TOOLING_VERSION/cmd/kubepkg/templates/latest/deb/kubelet/lib/systemd/system/kubelet.service
mv kubelet.service /usr/local/lib/systemd/system/kubelet.service
curl -OL https://raw.githubusercontent.com/kubernetes/release/v$KUBERNETES_RELEASE_TOOLING_VERSION/cmd/kubepkg/templates/latest/deb/kubeadm/10-kubeadm.conf
